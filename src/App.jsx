...
export default function App() {
  return (
    <div style={{ fontFamily: "Arial, sans-serif", padding: "2rem", maxWidth: 800, margin: "auto" }}>
      <h1 style={{ textAlign: "center" }}>Entretien Aquarium</h1>
      <p style={{ textAlign: "center" }}>Entretien d’aquariums à domicile et en entreprise</p>
